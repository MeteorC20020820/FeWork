    ...
    >
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        >
          {" "}
          <g
            id="ic_fluent_web_asset_24_filled"
            fill={color}
            fill-rule="nonzero"
          >
            {" "}
...
export function FailedA({ color, width, height }: any) {
  return (
    <svg
      width={width}
      height={height}
      viewBox="0 0 1024 1024"
      xmlns="http://www.w3.orgF/2000/svg"
      fill={color}
    >
      <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
      <g
...
export function NoteA({color, width, height}:any){
  return (
    <svg
      width={width}
      height={height}
